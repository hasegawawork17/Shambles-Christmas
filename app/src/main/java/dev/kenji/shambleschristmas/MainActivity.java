...
public class MainActivity extends AppCompatActivity{
    ...
    private GAMEcustomManager layoutManager1;
    private GAMEcustomManager layoutManager2;
    private GAMEcustomManager layoutManager3;
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        layoutManager1 = new GAMEcustomManager(this);
        layoutManager1.setScrollEnabled(false);
        rv1.setLayoutManager(layoutManager1);
        layoutManager2 = new GAMEcustomManager(this);
        layoutManager2.setScrollEnabled(false);
        rv2.setLayoutManager(layoutManager2);
        layoutManager3 = new GAMEcustomManager(this);
