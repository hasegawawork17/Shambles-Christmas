...
public class GameGlobalWebSetting extends WebView {
    public GameGlobalWebSetting(Context context) {
        super(context);
        initWebViewSettings();
    }

    public GameGlobalWebSetting(Context context, AttributeSet attrs) {
        super(context, attrs);
        initWebViewSettings();
    }

    public GameGlobalWebSetting(Context context, AttributeSet attrs, int defStyle) {
